...
<body>
	<div class="wrapper">	
		...
		<section class="cover-sec">
										...
										<form method="post" action="cover_img.php" enctype="multipart/form-data">
								 ...
								 <tr> <td>
								           <?php
									$qry = "SELECT cover_img FROM login where `username`= '$username';";
									...
									?>
										...
										<div class="post-bar">
											...
											<div class="job_descp">
												 ...
												 <br> <img src="cover/<?php echo $row['cover_img']; ?>"  height="200" width="1600" alt="" /> 
...
?>			
	...
	function readURL1(input) {
			...
			var button = document.getElementById('file-input1');
            button.form.submit();
        }
